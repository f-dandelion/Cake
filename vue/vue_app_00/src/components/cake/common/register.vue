   ...
   <div>
       <div class="xq">
        ...
        <div>
            ...
            <mt-field @blur.native.capture="checkRegular_p" class="input_border" label="密码" placeholder="请输入密码" v-model="upwd"></mt-field>
            <mt-field @blur.native.capture="checkRegular_cp" class="input_border" label="确认密码" placeholder="请确认密码" v-model="confirmUpwd"></mt-field>
